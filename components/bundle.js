...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.state = { comments: [{ text: 'hi', user: 'dave' }, { text: 'I did not have relations', user: 'bill' }] };
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', null, _react2.default.createElement('p', { className: 'greeting' }, 'Hello ', this.props.name, ', how are you?'), _react2.default.createElement('img', { src: this.props.img }), this.state.comments.map(function (comment, i) {
        return _react2.default.createElement('h1', { key: i }, comment.text);
      }));
    }
  }]);
...
_reactDom2.default.render(_react2.default.createElement(_basic2.default, null), app);
...
},{"./basic":1,"react":169,"react-dom":31}],3:[function(require,module,exports){
(function (process){
'use strict';
